...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _autoFillLogin() {
    _emailController.text = "Naufal@gmail.com"; // Email default (ganti terserah anda wak)
    _passwordController.text = "123456789"; // Password default
  }
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // Welcome Text
              const Text(
                'Selamat Datang di Aplikasi Penginapan',
